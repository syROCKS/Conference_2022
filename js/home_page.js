...
(function($) {
    ...
    var aboutUsContainer = $('.aboutUs-wrapper');
    var homeContainer = $('.home-wrapper');
        ...
        animate: function() {
            ...
            function openAnimation() {
                TweenMax.to(sceneContainer, 0.8, {
                    ...
                    onComplete: function() {
                        TweenMax.to(aboutUsContainer, 1.8, {
                            width: "100%",
                            ease: ITEManimate.bezier(0.930, 0.035, 0.350, 0.815),
                            top: "0%",
                            ease: ITEManimate.bezier(0.930, 0.035, 0.350, 0.815)
                        ...
                        aboutUsContainer.css({"overflow-y":"visible"});
                        aboutUsContainer.removeClass("hide");
                        aboutUsContainer.addClass("active");
                        setTimeout(
                            function() {
            ...
            function closeAnimation() {
                TweenMax.to(aboutUsContainer, 1.2, {
                    top: "100%",
